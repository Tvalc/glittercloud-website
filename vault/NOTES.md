...
The vault stays neutral grey until the finale, then takes the tier colour (getaway stays shut and dim). Crew who make it descend the tracker and appear at the door. **The tier glow leaks out around the door before it moves.** Once open, **one gem per crew member** waits in the opening. **The lockbox is only tried when all three are at the door**: found numbers fill its slots; three opens it, revealing a case — the gems go into the case and one man carries it out. Two numbers leaves it shut, and with one or two at the door it is simply not attempted: each man walks out with his gem.
